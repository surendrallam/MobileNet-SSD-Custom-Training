...
data_root_dir=/home/surendra/surendra/MobileNet-SSD/create_lmdb/Dataset/fruits_minimal  # Modify the path with your folder having Images and Labels directories.


dataset_name="fruits_minimal"  # This will be directory holding train and test LMDBs
